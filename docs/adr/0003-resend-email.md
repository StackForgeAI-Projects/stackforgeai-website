...
Use **Resend** as the transactional email API and **React Email** for templates. Outbound `From` is `StackForgeAI Contact Form <contact@stackforgeai.africa>`; `Reply-To` is the visitor. Inbox is `hello@stackforgeai.africa`.
