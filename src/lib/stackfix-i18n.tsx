...
export const stackfixDict = {
  en: {
    ...
    contact: {
      ...
      submit: "Send message",
      formSent: "Message sent ✓ We'll get back to you within 48 hours.",
      formSending: "Sending…",
  ...
  rw: {
    ...
    contact: {
      ...
      formSent: "Ubutumwa bwoherejwe ✓ Tuzakugarukira mu masaha 48.",
  ...
  fr: {
    ...
    contact: {
      ...
      formSent: "Message envoyé ✓ Nous vous répondrons sous 48 heures.",
