export type SiteDict = Record<string, string>;
...
export const en: SiteDict = {
  ...
  "contact.error.company": "Company is required",
  ...
  "footer.subscribed.detail":
    "Thanks! Check your inbox to confirm your subscription (double opt-in).",
